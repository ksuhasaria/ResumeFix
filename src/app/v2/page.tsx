                ...
                <div className="container">
                    <div style={{ textAlign: 'center', maxWidth: '900px', margin: '0 auto', padding: '0 1rem' }}>
                        <div style={{ display: 'inline-flex', alignItems: 'center', background: 'rgba(239, 68, 68, 0.1)', color: '#ef4444', padding: '0.5rem 1rem', borderRadius: '99px', fontSize: '0.85rem', fontWeight: 700, marginBottom: '2rem', border: '1px solid rgba(239, 68, 68, 0.2)' }}>
                            <AlertTriangle size={16} style={{ marginRight: '0.5rem' }} /> EXPOSED: The Dark Truth About Indian Hiring in 2026
                        </div>
                                ...
                                <div style={{ fontFamily: 'Georgia, serif', fontSize: '0.9rem', color: 'var(--foreground)' }}>
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', lineHeight: 1.5 }}>
                                        <div style={{ position: 'relative' }}>
                                            ...
                                            <b>Engineered</b> a high-throughput backend microservice using Node.js, reducing API latency by <b>35%</b> and saving ₹5L in annual server costs.
                                        </div>
                                        <div style={{ position: 'relative' }}>
                                            <span style={{ position: 'absolute', left: '-1.5rem', top: '0.1rem', color: 'var(--primary)' }}><CheckCircle size={14} /></span>
                ...
                <div className="container">
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
                        ...
                        <div className="glass" style={{ padding: '2rem', borderRadius: '1rem', background: 'var(--card)', border: '1px solid var(--border)' }}>
                            ...
                            <p style={{ fontSize: '1.05rem', marginBottom: '1.5rem', lineHeight: 1.6 }}>
                                "Worth every rupee. As a marketing professional, I struggled to put my impact into words. The AI perfectly reframed my bullet points to show ROI. Got exactly what was promised."
                            </p>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ background: 'var(--card)', padding: '3rem 2rem', borderRadius: '1.5rem', border: '2px solid var(--primary)', position: 'relative', display: 'flex', flexDirection: 'column', boxShadow: '0 10px 30px rgba(79, 70, 229, 0.15)' }}>
                            ...
                            <ul style={{ textAlign: 'left', listStyle: 'none', padding: 0, marginBottom: '2.5rem', display: 'flex', flexDirection: 'column', gap: '1rem', flexGrow: 1 }}>
                                ...
                                <li style={{ display: 'flex', gap: '0.75rem', alignItems: 'flex-start' }}>
                                    <CheckCircle size={20} color="var(--primary)" style={{ flexShrink: 0 }} />
                                    <span style={{ fontWeight: 600 }}>The 500+ Power-Verbs Database</span>
                                </li>
                                <li style={{ display: 'flex', gap: '0.75rem', alignItems: 'flex-start' }}>
                                    <CheckCircle size={20} color="var(--primary)" style={{ flexShrink: 0 }} />
                                    <span>Cold Email Swipe Files</span>
                                </li>
                                <li style={{ display: 'flex', gap: '0.75rem', alignItems: 'flex-start' }}>
                                    <CheckCircle size={20} color="var(--primary)" style={{ flexShrink: 0 }} />
                                    <span>30-Min Zoom Review with Expert</span>
                                </li>
                            </ul>
