        ...
        <main style={{ overflowX: 'hidden', background: 'var(--background)' }}>
            ...
            <section style={{ paddingTop: '5rem', paddingBottom: '4rem', position: 'relative' }}>
                <div className="container">
                    <div style={{ textAlign: 'center', maxWidth: '900px', margin: '0 auto', padding: '0 1rem' }}>
                        ...
                        <h1 style={{ fontSize: 'clamp(2.5rem, 6vw, 4.5rem)', lineHeight: 1.1, marginBottom: '1.5rem', letterSpacing: '-0.03em', fontWeight: 800 }}>
                            Your Resume Isn't Getting Rejected By Humans.<br />
                            <span style={{ color: '#ef4444' }}>It's Getting Blocked By Dumb Software.</span>
                        </h1>

                        <p style={{ fontSize: '1.25rem', color: 'var(--muted-foreground)', marginBottom: '3rem', lineHeight: 1.6, maxWidth: '750px', margin: '0 auto 3rem' }}>
                ...
                <div className="container" style={{ maxWidth: '1000px' }}>
                    <div style={{ background: 'var(--card)', padding: '1rem', borderRadius: '1.5rem', border: '1px solid var(--border)', boxShadow: '0 20px 40px rgba(0,0,0,0.05)' }}>
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1rem' }}>
                            ...
                            {/* BEFORE */}
                            <div style={{ background: 'var(--muted)', padding: '2rem', borderRadius: '1rem', position: 'relative', opacity: 0.8 }}>
                                <div style={{ position: 'absolute', top: '1rem', right: '1rem', transform: 'rotate(15deg)', border: '3px solid #ef4444', color: '#ef4444', fontWeight: 800, fontSize: '1.5rem', padding: '0.25rem 1rem', borderRadius: '0.5rem', opacity: 0.8 }}>
                                    REJECTED BY ATS
                                </div>
                                <span style={{ display: 'inline-flex', alignItems: 'center', background: 'rgba(239, 68, 68, 0.1)', color: '#ef4444', padding: '0.25rem 0.75rem', borderRadius: '99px', fontSize: '0.85rem', fontWeight: 600, marginBottom: '1.5rem' }}>
                                    The "Graphic" Canva Resume
                                </span>
                                <div style={{ fontFamily: 'monospace', fontSize: '0.85rem', color: 'var(--muted-foreground)', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                                    ...
                                    <div style={{ marginTop: '1rem' }}>
                                        <p style={{ color: '#ef4444', fontSize: '0.75rem', fontWeight: 700, marginBottom: '0.25rem' }}>ERROR: UNREADABLE FORMAT</p>
                                        <div style={{ padding: '0.75rem', borderLeft: '2px solid #ef4444', background: 'rgba(239, 68, 68, 0.05)' }}>
                                            • Responsible for maintaining database.<br />
                            ...
                            {/* AFTER */}
                            <div style={{ background: 'var(--card)', padding: '2rem', borderRadius: '1rem', border: '2px solid var(--primary)', position: 'relative', boxShadow: '0 10px 30px rgba(79, 70, 229, 0.1)' }}>
                                <div style={{ position: 'absolute', top: '1rem', right: '1rem', transform: 'rotate(-5deg)', border: '3px solid #22c55e', color: '#22c55e', fontWeight: 800, fontSize: '1.5rem', padding: '0.25rem 1rem', borderRadius: '0.5rem' }}>
                                    INTERVIEW STAGE
                                </div>
                                <span style={{ display: 'inline-flex', alignItems: 'center', background: 'rgba(34, 197, 94, 0.1)', color: '#22c55e', padding: '0.25rem 0.75rem', borderRadius: '99px', fontSize: '0.85rem', fontWeight: 600, marginBottom: '1.5rem' }}>
                                    The ResumeFix Format
                                </span>
                                <div style={{ fontFamily: 'Georgia, serif', fontSize: '0.9rem', color: 'var(--foreground)' }}>
                                    <div style={{ fontWeight: 700, fontSize: '1.1rem', marginBottom: '0.25rem' }}>Senior Software Engineer</div>
                                    <div style={{ color: 'var(--muted-foreground)', marginBottom: '1.5rem', fontSize: '0.8rem' }}>Tech Corp | 2023 - Present</div>

                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', lineHeight: 1.5 }}>
                                        <div style={{ position: 'relative' }}>
                                            <span style={{ position: 'absolute', left: '-1.5rem', top: '0.1rem', color: 'var(--primary)' }}><CheckCircle size={14} /></span>
                                            <b>Engineered</b> a high-throughput backend microservice using Node.js, reducing API latency by <b>35%</b> and saving $50,000 in annual server costs.
                                        </div>
                                        <div style={{ position: 'relative' }}>
                                            <span style={{ position: 'absolute', left: '-1.5rem', top: '0.1rem', color: 'var(--primary)' }}><CheckCircle size={14} /></span>
                                            <b>Spearheaded</b> the migration from monolithic architecture to AWS Lambda, achieving <b>99.99% uptime</b> and zero data loss.
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section style={{ padding: '2rem 1rem', background: 'var(--primary)', color: 'white', textAlign: 'center' }}>
                <div className="container">
                    ...
                    <div style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', opacity: 0.8, fontWeight: 800, fontSize: '1.5rem', gap: '3rem' }}>
                        <span>GOOGLE</span>
                        <span>META</span>
                        <span>AMAZON</span>
                        <span>STRIPE</span>
            ...
            <section style={{ padding: '5rem 1rem' }}>
                <div className="container">
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
                        <div className="glass" style={{ padding: '2rem', borderRadius: '1rem', background: 'var(--card)', border: '1px solid var(--border)' }}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                                <img src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=100&h=100&fit=crop" alt="Michael" style={{ width: '48px', height: '48px', borderRadius: '50%', objectFit: 'cover' }} />
                                <div>
                                    <div style={{ fontWeight: 600 }}>Michael Chen</div>
                                    <div style={{ fontSize: '0.85rem', color: 'var(--muted-foreground)' }}>Software Engineer, 25</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="glass" style={{ padding: '2rem', borderRadius: '1rem', background: 'var(--card)', border: '1px solid var(--border)' }}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                                <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop" alt="Sarah" style={{ width: '48px', height: '48px', borderRadius: '50%', objectFit: 'cover' }} />
                                <div>
